...
class HomePage extends StatefulWidget {
  ...
  static const primary500 = Color(0xFF198DE5);
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        backgroundColor: HomePage.primary50, // Background color
        body: SafeArea(
                ...
                Stack(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(color: HomePage.primary500),
                    ),
                    Padding(
                                            ...
                                            MaterialPageRoute(
                                              builder:
                                                  (context) => RoutesPage(
                                                    ...
                                                    selectedMode:
                                                        "TRANSIT", // You may want to add mode selection
                                                    timeType:
                                                        dateTime.mode ==
                                                                DateTimePickerMode
                                                                    .now
